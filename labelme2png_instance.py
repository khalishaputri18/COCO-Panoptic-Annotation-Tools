...
#directories
root_dir = 'instance/train2/'   #instance labelme json input path
...
out_dir = 'annotations_ins1_train2'     #png instance annotations output path 1
out_dir1 = 'annotations_ins2_train2'    #png instance annotations output path 2
