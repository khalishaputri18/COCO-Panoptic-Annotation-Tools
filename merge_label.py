...
ins_dir = 'annotations_ins1_train2'     #png instance annotations input path (output from labelme2png_instance.py)
sem_dir = 'annotations_sem1_train2'     #png semantic annotations input path (output from labelme2png_semantic.py)
pan_dir = 'annotations_pan_train2'      #png panoptic annotation output path
sem_dir2 = 'annotations_sem2_train2'    #png semantic annotations input path (output from labelme2png_semantic.py)
